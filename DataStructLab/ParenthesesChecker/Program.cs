...
namespace ParenthesesChecker
{
    internal class Program
    {
        ...
        // Programmet startar här och hanterar användarens menyval för att kontrollera parentesbalans
        // med tre olika metoder: Stack, LinkedList och Array.
        static void Main()
        {
            bool running = true;
        ...
        // Kontrollerar om parenteserna i ett uttryck är balanserade med hjälp av en inbyggd Stack.
        // Returnerar true om varje öppnande parentes har en motsvarande stängande parentes i rätt ordning.
        ...
        // Kontrollerar om parenteserna i ett uttryck är balanserade med hjälp av en egen implementerad länkad lista.
        // Returnerar true om varje öppnande parentes har en motsvarande stängande parentes i rätt ordning.
        ...
        // Kontrollerar om parenteserna i ett uttryck är balanserade med hjälp av en array som simulerar en stack.
        // Returnerar true om varje öppnande parentes har en motsvarande stängande parentes i rätt ordning.
